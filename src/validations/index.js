...
module.exports = [
    ...
    check('firstname')
        ...
        .isLength({min: 2, max: 100}).withMessage('El nombre debe tener entre 2 y 50 caracteres')
    ...
    check('lastname')
        ...
        .isLength({min: 2, max: 100}).withMessage('El apellido debe tener entre 2 y 50 caracteres')
    ...
    check('box')
        ...
        .isLength({min: 1, max: 20 }).withMessage('La caja debe tener entre 2 y 20 caracteres')
        .matches(/^[a-zA-ZáéíóúÁÉÍÓÚñÑ0-9\s]+$/).withMessage('El numero de caja solo debe contener letras y números'),
]