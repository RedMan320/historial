...
module.exports = [
    check('hc')
        ...
        .matches(/^[a-zA-Z0-9\s]+$/).withMessage('La historia clinica solo debe contener letras y números'),    
    check('firstname')
        .trim()
        .toLowerCase()
        .notEmpty().withMessage('El nombre no debe estar vacio').bail()
        .isLength({min: 4, max: 100}).withMessage('El nombre debe tener entre 2 y 50 caracteres')
    ...
    check('lastname')
        ...
        .isLength({min: 4, max: 100}).withMessage('El apellido debe tener entre 2 y 50 caracteres')
